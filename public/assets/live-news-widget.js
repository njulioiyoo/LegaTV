                    ...
                    lineslideItems: [
                        {
                            ...
                            content:
                                'The new game from the world famous "Eternity Studios" is back with a new adventure game with a lot of classic and puzzle elements',
                            separator:
                                '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>',
                        },
                        {
                            title: '<a href="post-v2.html" class="link">We reviewed the new Magimons game: </a>',
                            content:
                                "Magimons is an incredible take on classic RPGs with a new and fresh approach that includes a mindblowing soundtrack",
                            separator:
                                '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>',
                        },
                        {
                            ...
                            content:
                                "The latest movie from the franchise has a lot of interesting and fun stuff to look for",
                            separator:
                                '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>',
                        },
                        {
                        ...
                        },
                        {
                            ...
                            content:
                                "In an intense match, the Lone Wolves came out victorious. Read all about the big night here",
                            separator:
                                '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>',
                        },
                    ],
